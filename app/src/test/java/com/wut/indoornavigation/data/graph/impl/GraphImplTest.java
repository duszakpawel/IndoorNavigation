...
public class GraphImplTest {
    ...
    static {
        ...
        VERTICES.add(new Vertex(0, new Point(1, 2, 0)));
        VERTICES.add(new Vertex(1, new Point(2, 3, 0)));
        VERTICES.add(new Vertex(2, new Point(3, 4, 0)));
        VERTICES.add(new Vertex(3, new Point(4, 1, 0)));

        TWO_ITEMS_LIST = new LinkedList<>();
        TWO_ITEMS_LIST.add(new Vertex(0, new Point(1, 2, 0)));
        TWO_ITEMS_LIST.add(new Vertex(1, new Point(2, 3, 0)));
    }
